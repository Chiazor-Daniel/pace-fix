...
const Terms = () => (
  <Layout>
    <div className="container my-5 py-5">
      <h1 className="fw-bold mb-5 text-uppercase">Terms and Conditions</h1>
      <div className="page-content text-justify">
        <p>Last updated: March 21, 2020</p>
        <p>
          Welcome to <b>Pacesetter Frontier Magazine</b>!
        </p>
        <p>
          These terms and conditions outline the rules and regulations for the use of{" "}
          <b>Pacesetter Frontier Magazine</b>'s Website, located at https://www.pacesetterfrontier.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use{" "}
          <b>Pacesetter Frontier Magazine</b> if you do not agree to take all of the terms and conditions stated on this
          page.
        </p>
        <p>
        ...
        <p>
          We employ the use of cookies. By accessing <b>Pacesetter Frontier Magazine</b>, you agreed to use cookies in
          agreement with the <b>Pacesetter Frontier Magazine</b>'s <Link href="/privacy-policy">Privacy Policy</Link>.{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, <b>Pacesetter Frontier Magazine</b> and/or its licensors own the intellectual
          property rights for all material on <b>Pacesetter Frontier Magazine</b>. All intellectual property rights are
          reserved. You may access this from <b>Pacesetter Frontier Magazine</b> for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>
            Republish material from <b>Pacesetter Frontier Magazine</b>
          </li>
          <li>
            Sell, rent or sub-license material from <b>Pacesetter Frontier Magazine</b>
          </li>
          <li>
            Reproduce, duplicate or copy material from <b>Pacesetter Frontier Magazine</b>
          </li>
          <li>
            Redistribute content from <b>Pacesetter Frontier Magazine</b>
          </li>
        </ul>
        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. <b>Pacesetter Frontier Magazine</b> does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the views and opinions of{" "}
          <b>Pacesetter Frontier Magazine</b>,its agents and/or affiliates. Comments reflect the views and opinions of
          the person who post their views and opinions. To the extent permitted by applicable laws,{" "}
          <b>Pacesetter Frontier Magazine</b> shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments
          on this website.
        </p>
        <p>
          <b>Pacesetter Frontier Magazine</b> reserves the right to monitor all Comments and to remove any Comments
        ...
        <p>
          You hereby grant <b>Pacesetter Frontier Magazine</b> a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          <b>Pacesetter Frontier Magazine</b>; and (d) the link is in the context of general resource information.
        </p>
        <p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to <b>Pacesetter Frontier Magazine</b>. Please include your name, your
        ...
        <p>
          No use of <b>Pacesetter Frontier Magazine</b>'s logo or other artwork will be allowed for linking absent a

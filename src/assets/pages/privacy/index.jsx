  ...
  <Layout>
    <div className="container py-5 my-5">
      <div className="page-content">
        <h2 className="pb-5 fw-bold">PRIVACY POLICY</h2>

        <p className="text-end" data-element_type="column"></p>
        ...
        <p>
          Welcome to <strong> Pacesetter Frontier Magazine</strong>.
        </p>
        <p>
          <strong>Pacesetter Frontier Magazine</strong> (“us”, “we”, or “our”) operates{" "}
          <strong>https://pacesetterfrontier.com</strong> (hereinafter referred to as <strong>“Service”</strong>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <strong>https://pacesetterfrontier.com</strong>, and explains how we
        ...
        <p>
          <strong>SERVICE</strong> means the https://pacesetterfrontier.com website operated by Pacesetter Frontier
          Magazine.
        </p>
        <p>
        ...
        <p>
          ...
          with other persons) determines the purposes for which and the manner in which any personal data are, or are to
        ...
        <p>
          ...
          Service by or through any device (<strong>“Usage Data”</strong>).
        </p>
        <p>
        ...
        <p>
          0.2. <strong>Preference Cookies:</strong> We use Preference Cookies to remember your preferences and various
          settings.
        </p>
        <p>
        ...
        <p>
          0.4. <strong>Advertising Cookies:</strong> Advertising Cookies are used to serve you with advertisements that
        ...
        <p>Pacesetter Frontier Magazine uses the collected data for various purposes:</p>
        ...
        <p>
          If you are located outside Nigeria and choose to provide information to us, please note that we transfer the
          data, including Personal Data, to Nigeria and process it there.
        </p>
        <p>
        ...
        <p>
          Pacesetter Frontier Magazine will take all the steps reasonably necessary to ensure that your data is treated
          securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to
          an organisation or a country unless there are adequate controls in place including the security of your data
        ...
        <p>
          0.3. <strong>Other cases. We may disclose your information also:</strong>
        </p>
        ...
        <p>
          ...
          systems, please email us at <strong>thepacesetter03@gmail.com</strong>.
        </p>
        ...
        <p>
          11. <strong>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</strong>
        </p>
        <p>
        ...
        <p>
          ...
          <strong>thepacesetter03@gmail.com</strong>.
        </p>
        ...
        <p>
          12. <strong>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</strong>
        </p>
        <p>
        ...
        <p>
          16. <strong>Behavioral Remarketing</strong>
        </p>
        <p>
        ...
        <p>
          18. <strong>Links to Other Sites</strong>
        </p>
        <p>
